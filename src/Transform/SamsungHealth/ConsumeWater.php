...
use App\Transform\Base\BaseConsumeWater;
use DateTime;

class ConsumeWater extends BaseConsumeWater
{
    ...
    public function processData()
    {
        ...
        $this->saveEntityFromArray("App\Entity\ConsumeWater", $this->prepFromJson());
    ...
    private function prepFromJson()
    {
        ...
        $uomMg = self::getUnitOfMeasurement($this->getDoctrine(), $this->rawApiData['x-unitOfMeasurement']);
        ...
        $returnData["PatientGoal"] = self::getPatientGoal($this->getDoctrine(), "ConsumeWater", (250 * 8), $uomMg,
