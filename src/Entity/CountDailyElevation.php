...
/**
 * @ORM\Entity(repositoryClass="App\Repository\CountDailyElevationRepository")
...
class CountDailyElevation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Patient", inversedBy="elevationCount")
