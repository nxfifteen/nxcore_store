 ...
 */
final class Version20191022175816 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_264924A96B899279 ON site_news');
        $this->addSql('ALTER TABLE site_news DROP patient_id, DROP displayed, DROP link, DROP priority, CHANGE expires expires DATETIME DEFAULT \'NULL\', CHANGE accent accent VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE site_news ADD patient_id INT DEFAULT NULL, ADD displayed TINYINT(1) DEFAULT NULL, ADD link VARCHAR(255) DEFAULT NULL, ADD priority INT DEFAULT NULL, CHANGE expires expires DATETIME DEFAULT NULL, CHANGE accent accent VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE site_news ADD CONSTRAINT FK_264924A96B899279 FOREIGN KEY (patient_id) REFERENCES patient (id)');
        $this->addSql('CREATE INDEX IDX_264924A96B899279 ON site_news (patient_id)');
