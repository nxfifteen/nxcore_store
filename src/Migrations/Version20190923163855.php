 ...
 */
final class Version20190923163855 extends AbstractMigration
{
    /**
     * @return string
     */
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient_friends ADD accepted TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient_friends DROP accepted');
        $this->addSql('ALTER TABLE patient_goals CHANGE unit_of_measurement_id unit_of_measurement_id INT DEFAULT NULL');
