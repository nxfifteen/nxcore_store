 ...
 */
final class Version20190901162339 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_DE1CE7DFDEE7B414 ON fit_steps_daily_summary');
        $this->addSql('ALTER TABLE fit_steps_daily_summary DROP part_of_day_id, CHANGE remote_id remote_id VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fit_steps_daily_summary ADD part_of_day_id INT NOT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('CREATE INDEX IDX_DE1CE7DFDEE7B414 ON fit_steps_daily_summary (part_of_day_id)');
