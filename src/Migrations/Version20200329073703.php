...
final class Version20200329073703 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B40DF75DE934951A ON uploaded_file');
        $this->addSql('ALTER TABLE uploaded_file DROP exercise_id, DROP type');
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE uploaded_file ADD exercise_id INT DEFAULT NULL, ADD type VARCHAR(255) DEFAULT \'url\' NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_B40DF75DE934951A ON uploaded_file (exercise_id)');
        $this->addSql('ALTER TABLE workout_exercise CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE license_id license_id INT DEFAULT NULL');
    }
}
