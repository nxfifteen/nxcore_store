 ...
 */
final class Version20200329101555 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE workout_exercise CHANGE category_id category_id INT NOT NULL, CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE license_id license_id INT DEFAULT NULL');
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE workout_exercise CHANGE category_id category_id INT DEFAULT NULL, CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE license_id license_id INT DEFAULT NULL');
    }
}
