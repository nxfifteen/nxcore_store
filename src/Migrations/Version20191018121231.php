 ...
 */
final class Version20191018121231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rpg_challenge_global (id INT AUTO_INCREMENT NOT NULL, child_of_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, descripton LONGTEXT DEFAULT NULL, active TINYINT(1) DEFAULT NULL, criteria VARCHAR(255) DEFAULT NULL, target DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_F64797090B01EF (child_of_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
