 ...
 */
final class Version20191015110817 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient_membership DROP INDEX IDX_303F746A6B899279, ADD UNIQUE INDEX UNIQ_303F746A6B899279 (patient_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient_friends CHANGE accepted accepted TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE patient_goals CHANGE unit_of_measurement_id unit_of_measurement_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE patient_membership DROP INDEX UNIQ_303F746A6B899279, ADD INDEX IDX_303F746A6B899279 (patient_id)');
        $this->addSql('ALTER TABLE patient_membership CHANGE patient_id patient_id INT NOT NULL');
        $this->addSql('ALTER TABLE patient_settings CHANGE service_id service_id INT DEFAULT NULL');
