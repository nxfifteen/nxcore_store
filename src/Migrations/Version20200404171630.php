 ...
 */
final class Version20200404171630 extends AbstractMigration
{
    /**
     * @return string
     */
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rpg_rewards ADD indicator_id INT NOT NULL, CHANGE xp xp DOUBLE PRECISION DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_FBCA13084402854A ON rpg_rewards (indicator_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_FBCA13084402854A ON rpg_rewards');
        $this->addSql('ALTER TABLE rpg_rewards DROP indicator_id, CHANGE xp xp DOUBLE PRECISION DEFAULT \'NULL\', CHANGE image image VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
