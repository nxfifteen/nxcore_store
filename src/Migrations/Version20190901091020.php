 ...
 */
final class Version20190901091020 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fit_steps_daily_summary ADD patient_goal_id INT NOT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fit_steps_daily_summary DROP patient_goal_id, CHANGE remote_id remote_id VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
