 ...
 */
final class Version20190908083718 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD first_name VARCHAR(255) DEFAULT NULL, ADD sur_name VARCHAR(255) DEFAULT NULL, ADD avatar VARCHAR(255) DEFAULT NULL, ADD ui_settings JSON DEFAULT NULL COMMENT \'(DC2Type:json_array)\', CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient DROP first_name, DROP sur_name, DROP avatar, DROP ui_settings, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
        $this->addSql('ALTER TABLE patient_goals CHANGE unit_of_measurement_id unit_of_measurement_id INT DEFAULT NULL');
