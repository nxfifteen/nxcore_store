 ...
 */
final class Version20191019153511 extends AbstractMigration
{
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F647970DA7C9F35 ON rpg_challenge_global');
        $this->addSql('ALTER TABLE rpg_challenge_global DROP unit_of_measurement_id, CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE reward_id reward_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT \'NULL\', CHANGE criteria criteria VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE target target DOUBLE PRECISION DEFAULT \'NULL\', CHANGE progression progression VARCHAR(5) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE xp xp DOUBLE PRECISION DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE site_news CHANGE expires expires DATETIME DEFAULT \'NULL\', CHANGE accent accent VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rpg_challenge_global ADD unit_of_measurement_id INT DEFAULT NULL, CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE reward_id reward_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT NULL, CHANGE criteria criteria VARCHAR(255) DEFAULT NULL, CHANGE target target DOUBLE PRECISION DEFAULT NULL, CHANGE progression progression VARCHAR(5) DEFAULT NULL, CHANGE xp xp DOUBLE PRECISION DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_F647970DA7C9F35 ON rpg_challenge_global (unit_of_measurement_id)');
        $this->addSql('ALTER TABLE rpg_challenge_global_patient CHANGE finish_date_time finish_date_time DATETIME DEFAULT NULL, CHANGE progress progress DOUBLE PRECISION DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE site_news CHANGE expires expires DATETIME DEFAULT NULL, CHANGE accent accent VARCHAR(255) DEFAULT NULL');
