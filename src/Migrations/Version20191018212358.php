 ...
 */
final class Version20191018212358 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_F647970E466ACA1 ON rpg_challenge_global');
        $this->addSql('ALTER TABLE rpg_challenge_global DROP reward_id, CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT \'NULL\', CHANGE criteria criteria VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE target target DOUBLE PRECISION DEFAULT \'NULL\', CHANGE progression progression VARCHAR(5) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rpg_challenge_global ADD reward_id INT DEFAULT NULL, CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT NULL, CHANGE criteria criteria VARCHAR(255) DEFAULT NULL, CHANGE target target DOUBLE PRECISION DEFAULT NULL, CHANGE progression progression VARCHAR(5) DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F647970E466ACA1 ON rpg_challenge_global (reward_id)');
