 ...
 */
final class Version20200329101825 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE workout_exercise ADD category_id INT DEFAULT NULL, CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE license_id license_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_76AB38AA12469DE2 ON workout_exercise (category_id)');
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_76AB38AA12469DE2 ON workout_exercise');
        $this->addSql('ALTER TABLE workout_exercise DROP category_id, CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE license_id license_id INT DEFAULT NULL');
    }
}
