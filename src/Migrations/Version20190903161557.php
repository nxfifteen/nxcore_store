 ...
 */
final class Version20190903161557 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE food_database (id INT AUTO_INCREMENT NOT NULL, serving_unit_id INT DEFAULT NULL, service_id INT NOT NULL, provider_id VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, calorie DOUBLE PRECISION DEFAULT NULL, serving_amount DOUBLE PRECISION DEFAULT NULL, fat DOUBLE PRECISION DEFAULT NULL, total_fat DOUBLE PRECISION DEFAULT NULL, saturated_fat DOUBLE PRECISION DEFAULT NULL, carbohydrate DOUBLE PRECISION DEFAULT NULL, dietary_fiber DOUBLE PRECISION DEFAULT NULL, sugar DOUBLE PRECISION DEFAULT NULL, protein DOUBLE PRECISION DEFAULT NULL, serving_description VARCHAR(255) DEFAULT NULL, serving_number_default DOUBLE PRECISION DEFAULT NULL, INDEX IDX_E11E216CEC3181A7 (serving_unit_id), INDEX IDX_E11E216CED5CA9E6 (service_id), UNIQUE INDEX DeviceRemote (provider_id, service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
