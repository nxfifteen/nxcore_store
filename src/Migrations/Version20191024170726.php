 ...
 */
final class Version20191024170726 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE patient_device (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, user_agent LONGTEXT DEFAULT NULL, os VARCHAR(255) DEFAULT NULL, browser VARCHAR(255) DEFAULT NULL, device VARCHAR(255) DEFAULT NULL, os_version VARCHAR(255) DEFAULT NULL, browser_version VARCHAR(255) DEFAULT NULL, INDEX IDX_2615F746B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
