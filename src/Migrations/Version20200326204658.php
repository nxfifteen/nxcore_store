 ...
 */
final class Version20200326204658 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE workout_exercise DROP FOREIGN KEY FK_76AB38AA12469DE2');
        $this->addSql('ALTER TABLE workout_exercise DROP FOREIGN KEY FK_76AB38AA517FE9FE');
        $this->addSql('ALTER TABLE uploaded_file DROP FOREIGN KEY FK_B40DF75DE435DB6B');
        $this->addSql('ALTER TABLE workout_exercise DROP FOREIGN KEY FK_76AB38AAE7BC44CC');
        $this->addSql('ALTER TABLE workout_exercise DROP FOREIGN KEY FK_76AB38AA139DAB25');
        ...
        $this->addSql('ALTER TABLE exercise_type CHANGE tag tag VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE uploaded_file (id INT AUTO_INCREMENT NOT NULL, license_id INT NOT NULL, workout_exercise_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_B40DF75D460F904B (license_id), INDEX IDX_B40DF75DE435DB6B (workout_exercise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_categories (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_equipment (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_exercise (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, equipment_id INT DEFAULT NULL, muscle_primary_id INT DEFAULT NULL, muscle_secondary_id INT DEFAULT NULL, license_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_76AB38AA12469DE2 (category_id), INDEX IDX_76AB38AA517FE9FE (equipment_id), INDEX IDX_76AB38AAE7BC44CC (muscle_primary_id), INDEX IDX_76AB38AA139DAB25 (muscle_secondary_id), INDEX IDX_76AB38AA460F904B (license_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_muscle (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, is_front TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE uploaded_file ADD CONSTRAINT FK_B40DF75DE435DB6B FOREIGN KEY (workout_exercise_id) REFERENCES workout_exercise (id)');
        $this->addSql('ALTER TABLE workout_exercise ADD CONSTRAINT FK_76AB38AA12469DE2 FOREIGN KEY (category_id) REFERENCES workout_categories (id)');
        ...
        $this->addSql('ALTER TABLE workout_exercise ADD CONSTRAINT FK_76AB38AAE7BC44CC FOREIGN KEY (muscle_primary_id) REFERENCES workout_muscle (id)');
        $this->addSql('ALTER TABLE workout_exercise ADD CONSTRAINT FK_76AB38AA139DAB25 FOREIGN KEY (muscle_secondary_id) REFERENCES workout_muscle (id)');
        ...
        $this->addSql('ALTER TABLE exercise_summary CHANGE altitude_gain altitude_gain DOUBLE PRECISION DEFAULT NULL, CHANGE altitude_loss altitude_loss DOUBLE PRECISION DEFAULT NULL, CHANGE altitude_max altitude_max DOUBLE PRECISION DEFAULT NULL, CHANGE altitude_min altitude_min DOUBLE PRECISION DEFAULT NULL, CHANGE cadence_max cadence_max DOUBLE PRECISION DEFAULT NULL, CHANGE cadence_mean cadence_mean DOUBLE PRECISION DEFAULT NULL, CHANGE cadence_min cadence_min DOUBLE PRECISION DEFAULT NULL, CHANGE calorie calorie DOUBLE PRECISION DEFAULT NULL, CHANGE distance_incline distance_incline DOUBLE PRECISION DEFAULT NULL, CHANGE distance_decline distance_decline DOUBLE PRECISION DEFAULT NULL, CHANGE distance distance DOUBLE PRECISION DEFAULT NULL, CHANGE speed_max speed_max DOUBLE PRECISION DEFAULT NULL, CHANGE speed_mean speed_mean DOUBLE PRECISION DEFAULT NULL, CHANGE heart_rate_max heart_rate_max DOUBLE PRECISION DEFAULT NULL, CHANGE heart_rate_mean heart_rate_mean DOUBLE PRECISION DEFAULT NULL, CHANGE heart_rate_min heart_rate_min DOUBLE PRECISION DEFAULT NULL');
        $this->addSql('ALTER TABLE exercise_type CHANGE tag tag VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE site_nav_item CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL, CHANGE divider divider TINYINT(1) DEFAULT NULL, CHANGE title title TINYINT(1) DEFAULT NULL, CHANGE icon icon VARCHAR(255) DEFAULT NULL, CHANGE badge_variant badge_variant VARCHAR(255) DEFAULT NULL, CHANGE badge_text badge_text VARCHAR(255) DEFAULT NULL, CHANGE access_level access_level VARCHAR(255) DEFAULT NULL, CHANGE require_service require_service LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
