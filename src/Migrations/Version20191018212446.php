 ...
 */
final class Version20191018212446 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rpg_challenge_global ADD xp DOUBLE PRECISION DEFAULT NULL, CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE reward_id reward_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT NULL, CHANGE criteria criteria VARCHAR(255) DEFAULT NULL, CHANGE target target DOUBLE PRECISION DEFAULT NULL, CHANGE progression progression VARCHAR(5) DEFAULT NULL');
