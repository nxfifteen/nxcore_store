 ...
 */
final class Version20200410214923 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contribution_license (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, link VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE exercise (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, tracking_device_id INT NOT NULL, part_of_day_id INT NOT NULL, exercise_type_id INT NOT NULL, date_time_start DATETIME NOT NULL, date_time_end DATETIME NOT NULL, remote_id VARCHAR(255) DEFAULT NULL, duration INT NOT NULL, steps INT DEFAULT NULL, live_data_blob LONGBLOB DEFAULT NULL, location_data_blob LONGBLOB DEFAULT NULL, INDEX IDX_AEDAD51C6B899279 (patient_id), INDEX IDX_AEDAD51C1984B75B (tracking_device_id), INDEX IDX_AEDAD51CDEE7B414 (part_of_day_id), INDEX IDX_AEDAD51C1F597BD6 (exercise_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE exercise_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, tag VARCHAR(255) DEFAULT NULL, met DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE patient_device (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, user_agent LONGTEXT DEFAULT NULL, os VARCHAR(255) DEFAULT NULL, browser VARCHAR(255) DEFAULT NULL, device VARCHAR(255) DEFAULT NULL, os_version VARCHAR(255) DEFAULT NULL, browser_version VARCHAR(255) DEFAULT NULL, sms LONGTEXT DEFAULT NULL, last_seen DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, app VARCHAR(255) DEFAULT NULL, version VARCHAR(255) DEFAULT NULL, production TINYINT(1) DEFAULT NULL, INDEX IDX_2615F746B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE patient_friends (id INT AUTO_INCREMENT NOT NULL, friend_a_id INT NOT NULL, friend_b_id INT NOT NULL, accepted TINYINT(1) DEFAULT NULL, INDEX IDX_7C8D2582A1A48FB8 (friend_a_id), INDEX IDX_7C8D2582B3112056 (friend_b_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE patient_membership (id INT AUTO_INCREMENT NOT NULL, patient_id INT DEFAULT NULL, tear VARCHAR(255) NOT NULL, since DATETIME NOT NULL, active TINYINT(1) NOT NULL, lifetime TINYINT(1) NOT NULL, last_paid DATETIME NOT NULL, UNIQUE INDEX UNIQ_303F746A6B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE patient_settings (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, service_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, value JSON NOT NULL COMMENT \'(DC2Type:json_array)\', INDEX IDX_D2C0F8606B899279 (patient_id), INDEX IDX_D2C0F860ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rpg_challenge_friends (id INT AUTO_INCREMENT NOT NULL, challenger_id INT NOT NULL, challenged_id INT NOT NULL, target INT NOT NULL, invite_date DATETIME NOT NULL, start_date DATETIME DEFAULT NULL, duration INT NOT NULL, criteria VARCHAR(255) NOT NULL, outcome INT DEFAULT NULL, end_date DATETIME DEFAULT NULL, challenger_sum INT DEFAULT NULL, challenged_sum INT DEFAULT NULL, challenger_details LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', challenged_details LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', completed_at DATETIME DEFAULT NULL, INDEX IDX_5BDB23D2D521FDF (challenger_id), INDEX IDX_5BDB23D5820179C (challenged_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rpg_challenge_global (id INT AUTO_INCREMENT NOT NULL, child_of_id INT DEFAULT NULL, reward_id INT DEFAULT NULL, unit_of_measurement_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, descripton LONGTEXT DEFAULT NULL, active TINYINT(1) DEFAULT NULL, criteria VARCHAR(255) DEFAULT NULL, target DOUBLE PRECISION DEFAULT NULL, progression VARCHAR(5) DEFAULT NULL, xp DOUBLE PRECISION DEFAULT NULL, INDEX IDX_F64797090B01EF (child_of_id), UNIQUE INDEX UNIQ_F647970E466ACA1 (reward_id), INDEX IDX_F647970DA7C9F35 (unit_of_measurement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rpg_challenge_global_patient (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, challenge_id INT NOT NULL, criteria VARCHAR(255) NOT NULL, start_date_time DATETIME NOT NULL, finish_date_time DATETIME DEFAULT NULL, progress DOUBLE PRECISION DEFAULT NULL, INDEX IDX_AA07E8636B899279 (patient_id), INDEX IDX_AA07E86398A21AC6 (challenge_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rpg_indicator (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, data_set VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, comparator VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rpg_rewards (id INT AUTO_INCREMENT NOT NULL, indicator_id INT NOT NULL, name VARCHAR(255) NOT NULL, text VARCHAR(255) NOT NULL, text_long LONGTEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, payload LONGTEXT NOT NULL, INDEX IDX_FBCA13084402854A (indicator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE site_nav_item (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, divider TINYINT(1) DEFAULT \'0\' NOT NULL, title TINYINT(1) DEFAULT \'0\' NOT NULL, icon VARCHAR(255) DEFAULT NULL, display_order INT DEFAULT 0 NOT NULL, badge_variant VARCHAR(255) DEFAULT NULL, badge_text VARCHAR(255) DEFAULT NULL, child_of INT DEFAULT 0 NOT NULL, access_level VARCHAR(255) DEFAULT NULL, in_development TINYINT(1) DEFAULT \'0\' NOT NULL, require_service LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_news (id INT AUTO_INCREMENT NOT NULL, patient_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, text LONGTEXT NOT NULL, published DATETIME NOT NULL, expires DATETIME DEFAULT NULL, accent VARCHAR(255) DEFAULT NULL, displayed TINYINT(1) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, priority INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_264924A96B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uploaded_file (id INT AUTO_INCREMENT NOT NULL, license_id INT NOT NULL, exercise_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT \'url\' NOT NULL, UNIQUE INDEX UNIQ_B40DF75DB548B0F (path), INDEX IDX_B40DF75D460F904B (license_id), INDEX IDX_B40DF75DE934951A (exercise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_categories (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_56D709E25E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_equipment (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_F1E2B2D75E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_exercise (id INT AUTO_INCREMENT NOT NULL, equipment_id INT DEFAULT NULL, license_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_76AB38AA517FE9FE (equipment_id), INDEX IDX_76AB38AA460F904B (license_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE workout_muscle (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, is_front TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_E99206215E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_muscle_relation (id INT AUTO_INCREMENT NOT NULL, muscle_id INT NOT NULL, exercise_id INT NOT NULL, is_primary TINYINT(1) NOT NULL, INDEX IDX_56B0B011354FDBB4 (muscle_id), INDEX IDX_56B0B011E934951A (exercise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
