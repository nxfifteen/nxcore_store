 ...
 */
final class Version20190901111934 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE body_fat ADD fat_free_mass DOUBLE PRECISION DEFAULT NULL, ADD fat_free DOUBLE PRECISION DEFAULT NULL, ADD body_fat_mass DOUBLE PRECISION DEFAULT NULL, CHANGE part_of_day_id part_of_day_id INT DEFAULT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE body_fat DROP fat_free_mass, DROP fat_free, DROP body_fat_mass, CHANGE part_of_day_id part_of_day_id INT DEFAULT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
