 ...
 */
final class Version20200329102408 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE workout_exercise ADD license_id INT DEFAULT NULL, CHANGE equipment_id equipment_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_76AB38AA460F904B ON workout_exercise (license_id)');
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_76AB38AA460F904B ON workout_exercise');
