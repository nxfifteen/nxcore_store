 ...
 */
final class Version20190901183114 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fit_distance_daily_summary ADD unit_of_measurement_id INT NOT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fit_distance_daily_summary DROP unit_of_measurement_id, CHANGE remote_id remote_id VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
