 ...
 */
final class Version20190901110146 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient_goals ADD unit_of_measurement_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_5212C5E0DA7C9F35 ON patient_goals (unit_of_measurement_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5212C5E0DA7C9F35 ON patient_goals');
        $this->addSql('ALTER TABLE patient_goals DROP unit_of_measurement_id');
