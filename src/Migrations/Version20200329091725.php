 ...
 */
final class Version20200329091725 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_B40DF75DB548B0F ON uploaded_file');
        ...
        $this->addSql('DROP INDEX UNIQ_56D709E25E237E06 ON workout_categories');
        $this->addSql('DROP INDEX UNIQ_F1E2B2D75E237E06 ON workout_equipment');
        ...
        $this->addSql('DROP INDEX UNIQ_E99206215E237E06 ON workout_muscle');
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B40DF75DB548B0F ON uploaded_file (path)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_56D709E25E237E06 ON workout_categories (name)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F1E2B2D75E237E06 ON workout_equipment (name)');
        $this->addSql('ALTER TABLE workout_exercise CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE license_id license_id INT DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E99206215E237E06 ON workout_muscle (name)');
    }
}
