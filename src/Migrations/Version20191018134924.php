 ...
 */
final class Version20191018134924 extends AbstractMigration
{
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rpg_challenge_global DROP progression, CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT \'NULL\', CHANGE criteria criteria VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE target target DOUBLE PRECISION DEFAULT \'NULL\'');
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rpg_challenge_global ADD progression VARCHAR(5) DEFAULT NULL, CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT NULL, CHANGE criteria criteria VARCHAR(255) DEFAULT NULL, CHANGE target target DOUBLE PRECISION DEFAULT NULL');
