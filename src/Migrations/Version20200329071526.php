 ...
 */
final class Version20200329071526 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE site_nav_item CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL, CHANGE divider divider TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE title title TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE icon icon VARCHAR(255) DEFAULT NULL, CHANGE badge_variant badge_variant VARCHAR(255) DEFAULT NULL, CHANGE badge_text badge_text VARCHAR(255) DEFAULT NULL, CHANGE access_level access_level VARCHAR(255) DEFAULT NULL, CHANGE require_service require_service LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
