 ...
 */
final class Version20191018081600 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE site_nav_item ADD child_of INT NOT NULL, ADD access_level VARCHAR(255) DEFAULT NULL, ADD in_development TINYINT(1) NOT NULL, ADD require_service LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL, CHANGE divider divider TINYINT(1) DEFAULT NULL, CHANGE title title TINYINT(1) DEFAULT NULL, CHANGE icon icon VARCHAR(255) DEFAULT NULL, CHANGE badge_variant badge_variant VARCHAR(255) DEFAULT NULL, CHANGE badge_text badge_text VARCHAR(255) DEFAULT NULL');
