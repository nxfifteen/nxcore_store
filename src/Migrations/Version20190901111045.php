 ...
 */
final class Version20190901111045 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE body_fat CHANGE part_of_day_id part_of_day_id INT DEFAULT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE consume_caffeine ADD patient_goal_id INT DEFAULT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT NULL, CHANGE comment comment VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_2152F8363B1E4F15 ON consume_caffeine (patient_goal_id)');
        $this->addSql('ALTER TABLE consume_water ADD patient_goal_id INT DEFAULT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT NULL, CHANGE comment comment VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_11CA89993B1E4F15 ON consume_water (patient_goal_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE body_fat CHANGE part_of_day_id part_of_day_id INT DEFAULT NULL, CHANGE remote_id remote_id VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('DROP INDEX IDX_2152F8363B1E4F15 ON consume_caffeine');
        $this->addSql('ALTER TABLE consume_caffeine DROP patient_goal_id, CHANGE remote_id remote_id VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE comment comment VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE consume_water DROP FOREIGN KEY FK_11CA89993B1E4F15');
        $this->addSql('DROP INDEX IDX_11CA89993B1E4F15 ON consume_water');
        $this->addSql('ALTER TABLE consume_water DROP patient_goal_id, CHANGE remote_id remote_id VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE comment comment VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
