 ...
 */
final class Version20190831132314 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX DeviceRemote ON fit_steps_daily_summary (remote_id, tracking_device_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX DeviceRemote ON fit_steps_daily_summary');
        ...
        $this->addSql('DROP INDEX DeviceService ON tracking_device');
