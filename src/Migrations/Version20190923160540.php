 ...
 */
final class Version20190923160540 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE patient_friends (id INT AUTO_INCREMENT NOT NULL, friend_a_id INT NOT NULL, friend_b_id INT NOT NULL, INDEX IDX_7C8D2582A1A48FB8 (friend_a_id), INDEX IDX_7C8D2582B3112056 (friend_b_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
