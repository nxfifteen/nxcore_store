 ...
 */
final class Version20200404173846 extends AbstractMigration
{
    /**
     * @return string
     */
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rpg_rewards ADD type VARCHAR(255) NOT NULL, ADD payload LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rpg_rewards DROP type, DROP payload');
