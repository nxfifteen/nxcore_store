 ...
 */
final class Version20190914083848 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rpg_rewards (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, xp INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, text VARCHAR(255) NOT NULL, text_long LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rpg_xp (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, datetime DATETIME NOT NULL, reason VARCHAR(255) NOT NULL, INDEX IDX_7808C9536B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE patient CHANGE roles roles JSON NOT NULL, CHANGE first_name first_name VARCHAR(255) DEFAULT NULL, CHANGE sur_name sur_name VARCHAR(255) DEFAULT NULL, CHANGE avatar avatar VARCHAR(255) DEFAULT NULL, CHANGE ui_settings ui_settings JSON DEFAULT NULL COMMENT \'(DC2Type:json_array)\'');
