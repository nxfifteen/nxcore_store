 ...
 */
final class Version20191015105535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE patient_membership (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, tear VARCHAR(255) NOT NULL, since DATETIME NOT NULL, active TINYINT(1) NOT NULL, lifetime TINYINT(1) NOT NULL, INDEX IDX_303F746A6B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
