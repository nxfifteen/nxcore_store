 ...
 */
final class Version20191018122426 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rpg_challenge_global DROP INDEX IDX_F64797090B01EF, ADD UNIQUE INDEX UNIQ_F64797090B01EF (child_of_id)');
        $this->addSql('ALTER TABLE rpg_challenge_global CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT \'NULL\', CHANGE criteria criteria VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE target target DOUBLE PRECISION DEFAULT \'NULL\'');
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rpg_challenge_global DROP INDEX UNIQ_F64797090B01EF, ADD INDEX IDX_F64797090B01EF (child_of_id)');
        $this->addSql('ALTER TABLE rpg_challenge_global CHANGE child_of_id child_of_id INT DEFAULT NULL, CHANGE active active TINYINT(1) DEFAULT NULL, CHANGE criteria criteria VARCHAR(255) DEFAULT NULL, CHANGE target target DOUBLE PRECISION DEFAULT NULL');
