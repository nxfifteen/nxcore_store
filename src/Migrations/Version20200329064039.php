...
final class Version20200329064039 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE uploaded_file CHANGE workout_exercise_id workout_exercise_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE workout_exercise ADD muscle_primary_id INT DEFAULT NULL, ADD muscle_secondary_id INT DEFAULT NULL, CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE license_id license_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_76AB38AAE7BC44CC ON workout_exercise (muscle_primary_id)');
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_76AB38AAE7BC44CC ON workout_exercise');
        $this->addSql('DROP INDEX IDX_76AB38AA139DAB25 ON workout_exercise');
        $this->addSql('ALTER TABLE workout_exercise DROP muscle_primary_id, DROP muscle_secondary_id, CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE license_id license_id INT DEFAULT NULL');
    }
}
